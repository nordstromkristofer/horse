...
const Footer = () => {
  return (
    <footer class="text-center lg:text-left bg-[#F9EBC8] text-gray-600">
      ...
      <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          "
            ...
            <p>
              Det här är GoldenHorse, där det är vår plikt att göra din åktur
              säkrare och magisk!
            </p>
          </div>
          <div class="">
      ...
      <div class="text-center p-6 bg-orange-200">
        <span>© 2022 Copyright:</span>
        <a class="text-gray-600 font-semibold">Golden Horse</a>
      </div>
    </footer>
